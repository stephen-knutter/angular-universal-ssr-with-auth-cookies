...
function View_DashboardComponent_Host_0(_l) { return i1.ɵvid(0, [(_l()(), i1.ɵeld(0, 0, null, null, 1, "app-dashboard", [], null, null, null, View_DashboardComponent_0, RenderType_DashboardComponent)), i1.ɵdid(1, 114688, null, 0, i7.DashboardComponent, [i6.HeroService, i8.TransferState, "cookies"], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
var HEROES_KEY = platform_browser_1.makeStateKey('heroes');
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(heroService, state, cookies) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.state.get(HEROES_KEY, null);
        if (!this.heroes) {
            this.getHeroes();
        }
    };
    DashboardComponent.prototype.getHeroes = function () {
        ...
        this.heroService.getHeroes()
            ...
            _this.state.set(HEROES_KEY, heroes.slice(1, 5));
        });
    };
...
module.exports = __webpack_require__(/*! /Users/p2784356/Downloads/universal/src/main.server.ts */"./src/main.server.ts");
